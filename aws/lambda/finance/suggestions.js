// aws/lambda/finance/suggestions.js

// Build a sector-level summary of risks
function buildSectorView(risks) {
  const bySector = {};
...
// Generate a single top-level portfolio action
function topLevelAction(sectorSummary) {
...
module.exports = { buildSectorView, topLevelAction };